...
#' @return a pie chart illustrating the distribution of k nearest neighbors lineages to the query  
#' @export

get_piechart <- function(combined_mat, input_sample = NULL, selected_samples = NULL , type, k, ann, query_lineage) {
