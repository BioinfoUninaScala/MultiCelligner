...
#' @return a pie chart illustrating the distribution of the TCGA k nearest neighbors lineages to the query  
#' @export

get_piechart_tumor <- function(combined_mat, input_sample, k, ann, BNindex, sample_order) {
