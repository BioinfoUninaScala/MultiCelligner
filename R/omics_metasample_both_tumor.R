#' 
#' Generate an interactive plot that highlighting the tumor k nearest neighbors for the metasample
#'
#' @import plotly
#' @import crosstalk
#' @import reactable
...
#' @return an interactive plot that highlighting the tumor k nearest neighbors for the metasample
#' @export

omics_metasample_both_tumor <- function(combined_mat, reduced_mat, selected_samples, n, ann, omics_name) {
