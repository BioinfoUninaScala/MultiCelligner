#' 
#' Create a datatable of CL k nearest neighbors for the metasample sorted by distance, with samples information: lineage and subtype
#'
#' @import dplyr
...
get_metasample_ann_both_CL <- function(combined_mat, reduced_mat, selected_samples, n, ann) {
...
dist_top_filtered <- dist_metasmaple_1 %>% filter(grepl('ACH-00', sampleID))
