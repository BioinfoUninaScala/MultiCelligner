#' 
#' Create a datatable of tumor k nearest neighbors from the user query sorted by distance, with samples information: lineage and subtype
#'
#' @import dplyr
...
get_neighbors_table_tumor <- function(combined_mat, input_sample, k, ann, BNindex, sample_order) {
